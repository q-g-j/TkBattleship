...
class Cell(ViewBase):
    def __init__(self, parent: ttk.Frame, command_factory: CommandFactory, side: Side, pos: Position, cell_size: int,
                 **kwargs):
        super().__init__(parent, command_factory, width=cell_size, height=cell_size, padding=0, **kwargs)
